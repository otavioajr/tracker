...
- **Global scope**: `/Users/otavioajr/Documents/Projetos/tracker/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/otavioajr/Documents/Projetos/tracker/.claude/notes/`)
...
2. Glob `/Users/otavioajr/Documents/Projetos/tracker/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/otavioajr/Documents/Projetos/tracker/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/otavioajr/Documents/Projetos/tracker/.claude/notes/` — works in any directory
