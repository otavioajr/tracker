...
- Usage: Reference from command with `@/Users/otavioajr/Documents/Projetos/tracker/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/otavioajr/Documents/Projetos/tracker/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/otavioajr/Documents/Projetos/tracker/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
