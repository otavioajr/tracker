...
describe("AlertBell", () => {
  ...
  it("uses the higher unread count from loaded alerts when the count query is stale low", async () => {
    const alerts: AlertFeedAlert[] = [
      {
        id: "alert-1",
        type: "Velocidade",
    ...
    getUnreadAlertCount.mockResolvedValue(1);
    getAlerts.mockResolvedValue(alerts);
    alertBellMenuMock.mockReturnValue(null);
